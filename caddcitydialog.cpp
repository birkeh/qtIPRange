...
void cAddCityDialog::loadCountryList()
{
...
void cAddCityDialog::loadFederalStateList()
{
...
void cAddCityDialog::loadCityList()
{
	ui->m_lpCity->clear();
...
void cAddCityDialog::on_m_lpAddCountry_clicked()
{
	bool	bOK;
...
void cAddCityDialog::on_m_lpAddCity_clicked()
{
...
void cAddCityDialog::on_m_lpName_textChanged(const QString &arg1)
{
	if(arg1.isEmpty())
...
void cAddCityDialog::on_m_lpLocation_textChanged(const QString &arg1)
{
	if(arg1.isEmpty())
		ui->m_lpButtonBox->button(QDialogButtonBox::Ok)->setEnabled(false);
	else
...
void cAddCityDialog::setLocation(const QString& szLocation)
{
